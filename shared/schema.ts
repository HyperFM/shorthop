...
export const users = pgTable("users", {
  ...
  falsePickupCount: integer("false_pickup_count").default(0),
  leftBehindStrikes: integer("left_behind_strikes").default(0),
  phone: text("phone"),
...
export const shortHops = pgTable("short_hops", {
  ...
  leftBehindFlag: boolean("left_behind_flag").default(false),
  leftBehindAt: timestamp("left_behind_at"),
