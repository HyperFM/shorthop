...
const PLAN_DETAILS = {
  flex_hop: {
    ...
    perRide: "Auto-Hop scheduling included",
    features: [
      "Automatic scheduled hops (Auto-Hop)",
      "Schedule-based pickup coordination",
      "Expanded ride flexibility",
      "Priority matching with nearby drivers",
      "FlexHop badge on your profile",
    ],
  },
  power_hop: {
    name: "PowerHop",
    ...
    perRide: "Premium connection tier",
    features: [
      "Request the same driver again",
      "Direct messaging with drivers",
      "Follow drivers and riders",
      "Priority ride matching",
      "Inbox messaging system",
      "All FlexHop features included",
    ],
  },
};
